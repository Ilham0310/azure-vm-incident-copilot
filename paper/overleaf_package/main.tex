...
The gap this paper addresses is the limited published evidence on
...
retraining, and
(d)~deterministic post-LLM safety enforcement that is applied after
LLM generation and is not controlled by the LLM output. We present
such a system and evaluate it empirically
...
Azure-specific implementation, three system-design lessons may be
relevant to other LLM-assisted operations systems: (1)~\emph{deterministic
